...
public class Contador {
	...
	/*Los atributos estáticos son de la clase, no del objeto, por tanto, pueden existir muchas instancias de la clase,
	 * pero todas hacen referencia al mismo atributo estático que va estar en la clse.
	 * */
}
