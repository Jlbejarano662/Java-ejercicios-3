...
public class TestActivos {
	...
	public static void main(String[] args) {
		...
		System.out.println("Telefono:  Número: " + c1.getTelefono().getNumero() + " Operadora: "
				+ c1.getTelefono().getOperadora() + " Código: " + c1.getTelefono().getCodigo() + " Tiene WhatsApp: "
		...
		System.out.println("----Método activarUsuario----");
		System.out.println("Nombre: " + c1.getNombre());
		System.out.println("Apellido: " + c1.getApellido());
		System.out.println("Telefono:  Número: " + c1.getTelefono().getNumero() + " Operadora: "
				+ c1.getTelefono().getOperadora() + " Código: " + c1.getTelefono().getCodigo() + " Tiene WhatsApp: "
